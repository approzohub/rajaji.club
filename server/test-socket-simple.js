...
async function testSocketSimple() {
  try {
    console.log('🧪 Testing socket events with simple game...\n');
    ...
    await testBid.save();
    console.log('✅ Test bid created for queen_of_spades (Q♠)');
    ...
    const winningCard = 'Q ♠'; // Display format
    ...
    console.error('❌ Error testing socket simple flow:', error);
  } finally {
    mongoose.disconnect();
  }
}
